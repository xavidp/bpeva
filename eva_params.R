...
##
## * Add  after fastqc finished: "grep FAIL dir_out/*/summary.txt > dir_out/yymmdd_qc_fail_summary.txt"
##
...
## * Add preprocessing adapted to 454/Roche data. 
##   See  http://prinseq.sourceforge.net/Preprocessing_454_SFF_chart.pdf
