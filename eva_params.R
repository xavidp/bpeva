...
runParam <- FALSE #######################
####
p_gatk.local.realign.step2    <- runParam
p_gatk.local.realign.step3    <- runParam
#####
runParam <- TRUE #######################
####
p_index.bam.file		          <- runParam
p_stats			                  <- runParam
p_snpeff.count.reads          <- FALSE # runParam
#####
runParam <- FALSE #######################
####
p_exon.coverage   	          <- FALSE # runParam
p_variant.calling		          <- runParam
p_variant.filtering		        <- runParam
p_gatk.combine.vcfs           <- FALSE # runParam
